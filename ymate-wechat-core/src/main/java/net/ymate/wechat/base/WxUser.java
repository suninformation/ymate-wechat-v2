 ...
 * @version 1.0
 */
public class WxUser extends WxSnsUser {
    ...
    public WxUser(JSONObject result) {
        super(result);
        if (this.getErrCode() == 0) {
            ...
            JSONArray _tagIds = result.getJSONArray("tagid_list");
            if (_tagIds != null) {
                this.tagidList = _tagIds.toArray(new Integer[0]);
            }
        }
    }
