 ...
 * @version 1.0
 */
public class WxSnsUser extends WxResult {
    ...
    public WxSnsUser(JSONObject result) {
        super(result);
        if (this.getErrCode() == 0) {
            ...
            JSONArray _privileges = result.getJSONArray("privilege");
            if (_privileges != null) {
                this.privilege = _privileges.toArray(new String[0]);
            }
