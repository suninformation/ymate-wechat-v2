 ...
 * @version 1.0
 */
public class WxUserList extends WxResult {
    ...
    public WxUserList(JSONObject result) {
        super(result);
        if (this.getErrCode() == 0) {
            ...
            if (result.containsKey("data")) {
                JSONArray _openIds = result.getJSONObject("data").getJSONArray("openid");
                if (_openIds != null) {
                    this.data = _openIds.toArray(new String[0]);
                }
            }
        }
    }
