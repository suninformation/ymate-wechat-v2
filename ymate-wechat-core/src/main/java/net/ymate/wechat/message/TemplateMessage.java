...
public class TemplateMessage {
    ...
    public TemplateMessage putData(String key, String value) {
        this.data.put(key, new DataItem(value));
        return this;
    }

    public TemplateMessage putData(String key, String value, String color) {
