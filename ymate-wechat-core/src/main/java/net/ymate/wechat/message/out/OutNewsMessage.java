...
import net.ymate.wechat.base.WxArticle;
...
public class OutNewsMessage extends OutMessage {
    ...
    public OutNewsMessage(String fromUserName, String toUserName, WxArticle article) {
        super(fromUserName, toUserName, IWechat.MessageType.NEWS);
        this.articles.add(article);
    }

    public OutNewsMessage(String fromUserName, String toUserName, List<WxArticle> articles) {
        super(fromUserName, toUserName, IWechat.MessageType.NEWS);
    ...
    public JSONObject toJSON() {
        ...
        for (WxArticle _item : this.articles) {
